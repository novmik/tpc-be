...
class BsaTest {
    ...
    @Test
    void canCountDubois() { assertThat(Bsa.dubois(170, 70)).isEqualTo(1.809707801753247); }
    ...
    @Test
    void canGetAllMethodsWhenTwoParams() { assertThat(Bsa.allMethods(170, 70)).isNotNull(); }
