...
import static com.novmik.tpc.medicament.NumberDaysDrugExtractorConstant.EVERY_DAY;
import static com.novmik.tpc.medicament.NumberDaysDrugExtractorConstant.FIRST_DAY;
...
public class NumberDaysDrugExtractor {
  ...
  protected static Integer getNumberDaysDrug(final String strNumberDaysDrugTreatments,
    ...
    if (strNumberDaysDrugTreatments.contains(
