...
public class CostOfCompletedCaseOfTreatmentConstant {
    ...
    public static final String SUBJECT_ID_NUMBER_DRG_VALUE_CDT = "Субъект id/Номер КСГ/Значение КСГ указаны неверно: ";
    public static final String NUMBER_DRG_INCORRECT = "Номер КСГ не верный: ";
    public static final String VALUES_IN_TABLE_IS_NOT_EXISTS = "Значения БС/КУС в таблице отсутствуют: ";
    ...
    public static final String COEFFICIENT_SPECIFICITY_NOT_CORRECT = "Значение Коэффициента специфики не определено, со следующими параметрами КЗ: {}, Типом МО: {}";
    public static final String COEFFICIENT_SPECIFICITY_IS_ZERO = "Значение Коэффициента специфики не определено";
