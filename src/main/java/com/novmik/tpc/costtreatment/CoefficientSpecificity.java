...
Правительство РФ или федеральные органы исполнительной власти.
Критерии классификации МО, влияющие на тариф:
- медицинские организации, подведомственные Управлению делами
Президента РФ (typeMedicalInstitution = 1)
- федеральные медицинские организации на территории закрытого административно-территориального
образования (typeMedicalInstitution = 2)
- иные медицинских организации, оказывающие указанную специализированную медицинскую помощь;
при оказании медицинской реабилитации (typeMedicalInstitution = 3)
- образовательные организации высшего образования, осуществляющие оказание медицинской помощи
(typeMedicalInstitution = 4)
- иные федеральные медицинские организации (typeMedicalInstitution = 5)

а) 1,4 - при значении коэффициента относительной затратоемкости, равном 2 и более,
а для медицинских организаций, подведомственных Управлению делами Президента Российской Федерации,-
при значении коэффициента относительной затратоемкости, равном 1,7 и более;
б) 1,2 - при значении коэффициента относительной затратоемкости менее 2 и расположении федеральной
...
муниципального образования иных медицинских организаций, оказывающих указанную специализированную
медицинскую помощь, при оказании медицинской реабилитации, а для образовательных организаций
высшего образования, осуществляющих оказание медицинской помощи, медицинских организаций,
подведомственных Управлению делами Президента Российской Федерации,
- при значении коэффициента относительной затратоемкости менее 1,7;
...
public abstract class CoefficientSpecificity {
  ...
  public static float calculate(final float rateRelativeIntensity,
