...
public class ClientConstant {
    ...
    public static final String CLIENT_NOT_FOUND_BY_EMAIL = "Пользователя не найдено с электронной почтой: ";
    public static final String USER_FOUND_BY_EMAIL = "Пользователь найден по электронной почте: ";
